...
!(function () {
  ...
  var t = document.getElementById("customizer-styles"),
    ...
    o = `\n    :root {\n      ${
      ...
      `--ar-btn-hover-bg: ${e("theme-info-btn-hover-active-border-bg-color")};`
    }\n      ${
      e("theme-info-btn-hover-active-border-bg-color") &&
      `--ar-btn-hover-border-color: ${e(
      ...
      e("theme-info-btn-hover-active-border-bg-color") &&
      `--ar-btn-active-bg: ${e("theme-info-btn-hover-active-border-bg-color")};`
    }\n      ${
      e("theme-info-btn-hover-active-border-bg-color") &&
      `--ar-btn-active-border-color: ${e(
        "theme-info-btn-hover-active-border-bg-color"
  ...
  for (
    var l = document.querySelectorAll("#theme-colors .color-swatch"), d = 0;
    d < l.length;
    d++
  ) {
    ...
    (colorInput = l[d].querySelector('input[type="text"]')),
      ...
      h.addEventListener("input", function (e) {
        ...
        r("theme-" + e.target.id, a),
          ...
          i[e.target.id + "Btn"].style.setProperty("--ar-btn-border-color", a),
          ...
          i[e.target.id + "Btn"].style.setProperty("--ar-btn-disabled-bg", a),
          i[e.target.id + "Btn"].style.setProperty(
            "--ar-btn-disabled-border-color",
            a
          ),
          i[e.target.id + "OutlineBtn"].style.setProperty("--ar-btn-color", a),
      ...
      colorInput.addEventListener("change", function (e) {
        ...
        0 != o.length &&
          ...
          r("theme-" + n.id + "-btn-hover-active-border-bg-color", c(o, -10)),
          ...
          i[n.id + "Btn"].style.setProperty("--ar-btn-hover-bg", c(o, -10)),
          i[n.id + "Btn"].style.setProperty(
            "--ar-btn-hover-border-color",
            c(o, -10)
          ),
          i[n.id + "Btn"].style.setProperty("--ar-btn-active-bg", c(o, -10)),
          i[n.id + "Btn"].style.setProperty(
            "--ar-btn-active-border-color",
            c(o, -10)
          ),
          ...
          i[n.id + "OutlineBtn"].style.setProperty("--ar-btn-border-color", o),
          i[n.id + "OutlineBtn"].style.setProperty("--ar-btn-hover-bg", o),
          i[n.id + "OutlineBtn"].style.setProperty(
            "--ar-btn-hover-border-color",
            o
          ),
          i[n.id + "OutlineBtn"].style.setProperty("--ar-btn-active-bg", o),
          i[n.id + "OutlineBtn"].style.setProperty(
            "--ar-btn-active-border-color",
            o
          ),
  ...
  for (d = 0; d < B.length; d++)
    (B[d].value = e("theme-" + B[d].id + "multiplier") || B[d].value),
      B[d].addEventListener("input", function (e) {
        var t = e.target.value;
        r("theme-" + e.target.id, "calc(var(--ar-border-radius) * " + t + ")"),
  ...
  P.addEventListener("click", function () {
    ...
    e.selectNode(n),
      ...
      (this.innerHTML = '<i class="bi-check me-2 ms-n1"></i>Copied!'),
      setTimeout(function () {
        P.innerHTML = '<i class="bi-copy me-2 ms-n1"></i>Copy styles';
      }, 2e3);
  });
})();
